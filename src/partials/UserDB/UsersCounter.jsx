    ...
    <div className='users-info-outer pb-14'>
     <div className="db-info-top">
              <div className='flex justify-between  '>
                <CountCard name="Total Users" color={["#53b7ff"]} value={totalUsers} repValues={[totalUsers]}/>

                <CountCard name="Safe" color={['#51D323','#E4E8EF']} value={safeCount} repValues={[safeCount, totalUsers]}/>
                
                <CountCard name="Panic" color={['#FF7B00', '#E4E8EF']} value={panicCount} repValues={[panicCount, totalUsers]}/>
                <CountCard name="Danger" color={['#E22A26', '#E4E8EF']} value={dangerCount} repValues={[dangerCount, totalUsers]}/>
              </div>
            </div>
    </div>
  )
