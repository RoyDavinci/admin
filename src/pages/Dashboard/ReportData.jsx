...
const ReportData = () => {
   ...
   console.log( "All users: ", users)
    ...
    const columns = [
  { field: 'assets', headerName: 'Media',  width: 70, height: 70, renderCell: (params) => {
    return (
      <>
        <img src={params.value[0]}  alt="image" style={{width: 50, height: 50,padding: 10, borderRadius:"50%"}}/>
